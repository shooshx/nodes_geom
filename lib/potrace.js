...
var Potrace = (function() {
  ...
  Bitmap.prototype.copy = function() {
    var d = new Int8Array(this.w * this.h)
    d.set(this.data)
    return new Bitmap(d, this.w, this.h);
  };
  ...
  function setBm(arr, width, height) { // arr is Int8Array with 0,1 values
    bm = new Bitmap(arr, width, height)
    info.isReady = true;
  }
